...
export default function ProductList() {
  ...
  // ✅ Filter: chỉ lấy products có status = 'ACTIVE' VÀ isFeatured = true
  const allProducts = (productsResponse?.data as Product[]) || [];
  const products = allProducts.filter(
    (p) => 
      p.status === 'ACTIVE' && p.isFeatured === true
  );
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        {products.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 text-lg font-medium">Chưa có sản phẩm nổi bật</p>
